...
class ProlongationsReport extends ReportsAbstract
{
    ...
    public static function processing($contractId)
    {
         ...
         * Сумма обязательства
         */
        $report->base_part->contract->contract_amount->sum = $contract->loan_body_summ;
        /*
         ...
         */
        $report->base_part->contract->payment_terms->op_next_payout_sum = $contract->loan_body_summ;
        /*
         * Дата ближайшего следующего платежа по основному долгу
         */
        $report->base_part->contract->payment_terms->op_next_payout_date = date('d.m.Y', strtotime('+30 day'));
        /*
         ...
         */
        $report->base_part->contract->payment_terms->percent_next_payout_date = date('d.m.Y', strtotime('+30 day'));
        /*
         ...
         */
        $report->base_part->contract->debt->first_sum = $contract->loan_body_summ + $contract->loan_percents_summ;
