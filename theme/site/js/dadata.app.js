;function DadataAddressApp($block)
{
    ...
    var _init = function(){
        ...
        app.$input.okato = app.$block.find('.js-dadata-okato');
        app.$input.oktmo = app.$block.find('.js-dadata-oktmo');
    };
    ...
    var _init_autocomplete_region = function(){
        app.$input.region.autocomplete({
            ...
            onSelect: function(suggestion){
                ...
                app.$input.okato.val(suggestion.data.okato);
                app.$input.oktmo.val(suggestion.data.oktmo);
