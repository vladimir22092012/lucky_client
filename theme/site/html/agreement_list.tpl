    ...
    <div class="">
        <div class="form_row">
            <div class="check">
                ...
                <input type="checkbox" class="custom-checkbox" id="service_reason" value="1"/>
    ...
    <div class="">
        <div class="form_row">
            <div class="check">
                ...
                <input type="checkbox" class="custom-checkbox" id="pravila_obrabotki" value="1"/>
    ...
    <div class="">
        <div class="form_row">
            <div class="check">
                ...
                <input type="checkbox" class="custom-checkbox" id="bki" value="1"/>
        ...
        <div class="">
            <div class="form_row">
                <div class="check">
                    ...
                    <input type="checkbox" class="custom-checkbox" id="individ" value="1"/>
        ...
        <div class="">
            <div class="form_row">
                <div class="check">
                    ...
                    <input type="checkbox" class="custom-checkbox" id="polis" value="1"/>
