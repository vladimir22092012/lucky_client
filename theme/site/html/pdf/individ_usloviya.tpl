...
<table border="1" width="530" cellspacing="0" cellpadding="2">
    ...
    <tr>
        ...
        <td width="225">
            <p>Количество платежей – 1 (Один)<br>Размер платежа - {$return_amount} ({$return_amount|price_string|upper}
    ...
    <tr>
        ...
        <td width="225">
            Заемщик разрешает Кредитору уступить права (требования) к Заёмщику по
