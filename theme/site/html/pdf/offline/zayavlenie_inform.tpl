<table width="535px">
    <tr>
        <td width="100%" align="center"><strong style="font-size:8px">Заявление
            <br />на предоставление услуги голосового информирования</strong>										
            <br />
        </td>
    </tr>
    <tr>
        <td width="100%" align="left" style="font-size:8px">1. Я, 
            ...
            предоставить мне услугу голосового сообщения (Далее по тексту - Услуга) на следующих условиях:										                
        </td>
    </tr>
    <tr>
    ...
    <tr>
        <td width="100%" align="left" style="font-size:8px">1.2. 
            Стоимость услуги -  30 руб.										
        </td>
    </tr>
    <tr>
        <td width="100%" align="left" style="font-size:8px">1.3. 
            Номер телефона для направления голосового сообщения 8(937)426-33-50.
            <br />
        </td>
    </tr>
    <tr>
    ...
    <tr>
        <td width="15px" align="" >
            <img src="{$config->front_url}/theme/site/html/pdf/i/checkbox_on.png" height="12px" />
        </td>
        <td width="" align="left" style="font-size:8px;vertical-align:bottom">
