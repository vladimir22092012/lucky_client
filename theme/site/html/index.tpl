...
<div class="wrapper">
                    ...
                    <div class="header_right">
                        <div class="header_right_row">
                            ...
                            <div class="header_contacts">
                                <a href="tel:88126042878" class="header_phone -gil-b -fs-24">8 812 604 28 78</a>
    ...
    <header class="mobheader">
        ...
        <div class="mobheader-phone">
            <a href="tel:88126042878" class="">8 812 604 28 78</a>
        ...
        <div class="container">
                ...
                <div class="col-sm-6 col-md-4 col-lg-3 footer-col-contacts">
                    <div class="footer_contacts -fs-14">
                        ...
                        <div class="work_time">
                            ...
                            <div class="work_time_text">понедельник - пятница <br>с 9:00 до 19:00</div>
                        </div>
                    </div>
                </div>
            </div>
            <div class="footer_row">
                <div class="copyright -fs-15">
                    ...
                    <br/>
                    Сокращенное наименование: ООО «МКК БАРВИЛ ХД»
                    ИНН 7801323165
                    ОГРН 1167847454642
                    <br/>
                    Регистрационный номер записи в государственном реестре микрофинансовых организаций 1703140008263 от
                    15.05.2017
                    <br/>
                    ...
                    литера А, кв. 188
                    <br/>
                    Режим работы: понедельник-пятница с 9.00 до 19.00. Время работы обособленных подразделений
...
{if !$is_developer}
{literal}
    <script src="//code.jivo.ru/widget/J4p4uZJUkT" async></script>
